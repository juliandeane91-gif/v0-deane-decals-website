      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 py-20 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <a href="/shop#custom"><Button size="lg" className="rounded-full bg-red-700 px-8 py-6 text-base font-bold text-white shadow-xl shadow-red-950/40 hover:bg-red-600">Start Custom Order<ArrowRight className="ml-2 h-5 w-5" /></Button></a>
